            ...
            <div class="bg-white/80 backdrop-blur-md border border-gray-100 shadow-2xl sm:rounded-3xl p-8 sm:p-12">
                <div class="mb-10">
                    <div class="inline-flex items-center gap-3 mb-4">
                        ...
                        <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">{{ __('Define New Prompt') }}</h1>
                    </div>
                    <p class="text-gray-500 text-lg font-medium">{{ __('Set up your system instructions and structured output schemas.') }}</p>
                </div>

                <form method="post" action="{{ route('prompts.store') }}" class="space-y-10">
                    @csrf
