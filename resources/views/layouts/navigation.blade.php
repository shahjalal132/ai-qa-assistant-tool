<aside
    class="fixed inset-y-0 start-0 z-40 flex min-h-screen w-64 shrink-0 flex-col bg-[#34495E] text-white shadow-lg transition-transform duration-200 ease-out md:static md:translate-x-0"
